...
#include <QDebug>
extern void StartQryInvestorAccount();
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

extern TUstpFtdcOrderSysIDType g_OrderSysID;
extern FILE * g_fpRecv;
extern QObject *object;

void SetRstRtnInfo(CUstpFtdcInputOrderField *pInputOrder)
{
    object->setProperty("direction",pInputOrder->Direction);//
    object->setProperty("offset",pInputOrder->OffsetFlag);
    object->setProperty("volume",pInputOrder->Volume);
    object->setProperty("price",pInputOrder->LimitPrice);
    object->setProperty("arbtrigeflag",pInputOrder->HedgeFlag);
    object->setProperty("selS",pInputOrder->InstrumentID);
    object->setProperty("tradeIdx",pInputOrder->OrderSysID);
}
